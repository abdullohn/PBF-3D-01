    ...
    return (
      <div>
        ...
        {(dataArtikel || []).map((artikel) => {
          // Menampilkan data dari firebase yang ditampung oleh var artikel
          return (
            // Parsing(memecah) data id dari variable artikel
            <div key={artikel.id}>
              <DaftarArtikel
                judul={artikel.title}
        ...
        <Modal show={this.state.showEdit} onHide={() => this.setState({ showEdit: false })} size="lg">
